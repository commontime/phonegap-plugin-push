...
module.exports = {
  ...
  removeFromIgnoreList: function removeFromIgnoreList(successCallback, errorCallback, messageId) {
  ...
  storeSMSSecret: function storeSMSSecret(successCallback, errorCallback, key) {
    exec(successCallback, errorCallback, 'PushNotification', 'setSmsKey', [key]);
  },

  syncTime: function syncTime(successCallback, errorCallback, timeDiff) {
